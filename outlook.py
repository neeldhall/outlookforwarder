...
class Outlook():
    ...
    def login(self, username, password):
        ...
        while True:
            try:
                ...
                print("\033[1;37m Signed in as " + self.username)
                return
    ...
    def sendEmailMIME(self, recipient, subject, message):
        ...
        # content = headers + "\r\n\r\n" + message
        try:
            self.smtp = smtplib.SMTP(str('smtp-mail.outlook.com'), int(587))
            self.smtp.ehlo()
            self.smtp.starttls()
    ...
    def sendEmail(self, recipient, subject, message):
        ...
        while True:
            try:
                ...
                print("\033[1;32m      Email sent.")
                return
            except Exception as err:
                print("\033[0;31m      Sending email failed: %s" % str(err))
                attempts = attempts + 1
                if attempts < 3:
                    continue
    ...
    def getEmail(self, id):
        r, d = self.imap.fetch(str(id),'(RFC822)')
